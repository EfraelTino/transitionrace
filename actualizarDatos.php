...
$encoded_query_string = $_GET["q"];

$query_string = base64_decode($encoded_query_string);
    ...
    <div class="container">
        ...
        <div class="row m-0 p-0 justify-content-center">
            <div class="col-12 col-md-5 ">
                <form class="mt-3" action="operaciones/logicaActualziarDatos.php" method="GET">
                    <div class="row m-0 p-0 align-items-center">
                        ...
                        <div class="col-12 mb-2">
                            <input type="text" class="form-control celular" required name="celular" value="<?php echo $telefono; ?>">
                        </div>
                        <div class="col-12 mb-2">
