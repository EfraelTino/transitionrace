								...
								<form class="form-horizontal form-label-left" method="POST" action="operaciones/actualizar_docente.php">
									...
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<select name="id_cargo" id="id_cargo" class="form-control col-md-7 col-xs-12" value="<?php echo $res_b_docente['id_cargo']; ?>">
												<option value="">Seleccione</option>
												<?php
												$id_cat = $res_b_docente['id_cargo'];
												$buscar_categoria = buscarCargo($conexion);
												while ($res_b_cat = mysqli_fetch_array($buscar_categoria)) {
													$id_cargo = $res_b_cat['id'];
												?>
													<option value="<?php echo $res_b_cat['id']; ?>" <?php if ($id_cat == $id_cargo) {
														echo "selected";
																																								}
																																								?>>
														<?php echo $res_b_cat['descripcion']; ?></option>
												<?php
												};
												?>
											</select>
									...
									<div class="form-group">
										<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
											<a href="./docentes.php" class="btn btn-primary" type="button">Cancelar</a>
