...
<head>
    ...
    <title>Registration form Expert</title>
</head>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-12 video-container video" >
                                        <video src="video/video_transition.mp4" autoplay controls width="100%" height="auto">Tu navegador no soporta la etiqueta de vieo</video>
                                    </div>
                                    <div class="col-12">
    ...
    <div class="container">
        <div class="row">
            <div class="col div-content justify-content-center align-items-center d-flex flex-column">
                ...
                <img src="images/form/titile_pre_registro.png" class="img-fluid  text-center img-lgo-instruccioness" alt="">
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-12 col-md-5 ">
                <form class="mt-3" action="operaciones/logicaFormularioRegistroExpert.php" method="POST">
